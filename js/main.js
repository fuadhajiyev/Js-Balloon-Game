function Game() {
  ...
  this.infoBalloon = document.getElementById("info-ball");
...
Game.prototype.startGame = function() {
  ...
  this.infoBalloon.style.display = "none";
...
function strikeBallSound() {
  let strikeBallSound = document.getElementById("audio");
  strikeBallSound.play();
}
...
function showRestartButton() {
  ...
  restart.onclick = function() {
    let winSound = document.getElementById("audio-2");
...
function gameOver(instance) {
  let gameOver = document.getElementById("game-over");
  let loseSound = document.getElementById("audio-4");
